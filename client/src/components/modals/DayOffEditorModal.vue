<template>
  <div class="modal-overlay" @click.self="closeModal">
    <div class="modal-content">
      ...
      <p v-if="isEditing && editableData.date">Editing for: <strong>{{ formatDateForTitle(editableData.date) }}</strong></p>
...
input[type="date"].form-control-sm { height: calc(1.5em + 0.6rem + 2px); line-height: 1.5; cursor: pointer; }
