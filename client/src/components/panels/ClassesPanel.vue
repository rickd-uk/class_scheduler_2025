        ...
        <li v-for="cls in classes" :key="cls.id" class="item class-item">
          <div class="class-main-info">
            ...
            <div class="item-actions">
              <button class="btn btn-sm btn-secondary" @click="openEditModal(cls)" title="Edit Class">
                Edit
              </button>
              <button class="btn btn-sm btn-info" @click="openLinkModal(cls)" title="Link Textbooks">
                Link
              </button>
              <button class="btn btn-sm btn-danger" @click="handleDeleteClass(cls.id)"
            ...
            <ul>
              <li v-for="book in cls.textbooks" :key="book.id" class="linked-item">
                ...
                <div class="linked-item-actions">
                  <!-- <button class="btn btn-link btn-sm" title="Edit Link (Not Implemented)" -->
                  <!--   @click="handleEditLink(cls.id, book.id)" disabled> Edit -->
                  <!-- </button> -->
