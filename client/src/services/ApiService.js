  ...
  error => {
    ...
    if (response) {
        ...
        // Handle 403 Forbidden errors
             ...
             store.dispatch('ui/showNotification', { type: 'error', message: 'You do not have permission to perform this action.' }, { root: true });
        }
         ...
         store.dispatch('ui/showNotification', { type: 'error', message: 'Network error. Please check your connection.' }, { root: true });
    }
