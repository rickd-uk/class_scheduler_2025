...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      if (
        error.message.includes('column "subject" does not exist') ||
        error.message.includes(
          'column "subject" of relation "classes" does not exist',
        )
      ) {
        console.log(
          "Column 'subject' does not exist, likely already removed. Skipping removal.",
        );
      } else {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      console.log("Could not add 'subject', maybe exists?");
    }
  },
};
