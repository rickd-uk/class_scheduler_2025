...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      console.log(
        `[Migration 20250429105517] Describing table ${tableName}...`,
      );
      ...
      if (!tableDescription[columnName]) {
        console.log(
          `[Migration 20250429105517] Column ${columnName} does not exist in ${tableName}. Adding it...`,
        );
        ...
        console.log(
          `[Migration 20250429105517] Column ${columnName} added to ${tableName}.`,
        );
      } else {
        console.log(
          `[Migration 20250429105517] Column ${columnName} already exists in ${tableName}. Skipping add.`,
        );
      }
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      console.log(
        `[Migration 20250429105517] Attempting to remove column ${columnName} from ${tableName}...`,
      );
      await queryInterface.removeColumn(tableName, columnName, { transaction });
      console.log(
        `[Migration 20250429105517] Column ${columnName} removed from ${tableName} (if it existed).`,
      );
