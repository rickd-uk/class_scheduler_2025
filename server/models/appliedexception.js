    ...
    module.exports = (sequelize, DataTypes) => {
      class AppliedException extends Model {
        static associate(models) {
          ...
          AppliedException.belongsTo(models.ExceptionPattern, { foreignKey: 'exceptionPatternId' });
        }
      }
      AppliedException.init({
        ...
        reason: { // Reason for the day off or notes for the applied pattern
        ...
        indexes: [ // Ensure unique constraint matches migration
